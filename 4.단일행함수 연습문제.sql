...
SELECT CONCAT(SUBSTR(last_name, 1, 1), first_name)
FROM employees;
...
SELECT CEIL(salary/100)*100
--SELECT CEIL(salary/100),
--    salary
FROM employees;
...
SELECT REPLACE(last_name, SUBSTR(last_name, 2, 1), '*')
FROM employees;
...
SELECT RPAD(SUBSTR(first_name, 1, 3), LENGTH(first_name), '*') NAME, salary
FROM employees
