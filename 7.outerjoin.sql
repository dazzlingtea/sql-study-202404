...
-- LEFT JOIN: 46건 = INNER 41 + 부서가 없는 사원 5
-- RIGHT JOIN: 43건 = INNER 41 + 사원이 없는 부서 2
-- FULL JOIN: 48건 = INNER 41 + 5 + 2
...
SELECT 
    ...
    , A.emp_nm "사원명"
    , A.addr "사원주소"
    , A.direct_manager_emp_no "직속상사 사번"
    , B.emp_nm "상사명"
    , B.addr "상사주소"
FROM tb_emp A
LEFT JOIN tb_emp B
